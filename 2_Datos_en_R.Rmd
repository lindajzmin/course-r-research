...
* `r fontawesome::fa("check-double")` library(rio)
]
...
### 3. Guarde el data set corregido en una nueva variable llamada `profesores2`.

### 4. Guarde el data set en un archivo excel en su computadora.

### 5. Extraer la información del 6to encuestado.

### 6. Extraer la edad del 5to encuestado.
...
### 3. Guarde el data set corregido en una nueva variable llamada `baseprograma2`.

### 4. Guarde el data set en un archivo excel en su computadora.

### 5. Extraer la información del 5to encuestado.

### 6. Extraer la estatura del 9no encuestado.
