...
<img src="img/see_azul.jpeg" width="200px"/>
...
- Importación de datos de diferentes fuentes (csv, excel, spss, do)
- Tipos de datos y Operaciones básicas
- Preparar y manejar datos para el análisis con `tidyverse`
- Bases de `ggplot` para creación de gráficos
- Estadística descriptiva con RStudio
- Introducción a Rmarkdown. Compilar documentos R Markdown en un informe en diferentes formatos, como PDF, HTML o Word
- Crear notebooks para ejecutar directamente fragmentos de código de forma interactiva incluyendo gráficos y tablas
- Crear diapositivas para presentaciones (HTML5, LaTeX Beamer o PowerPoint)
- Generar formatos de artículos de revistas y libros
...
.pull-right[
```{r investigacion, echo=FALSE, out.width='100%', fig.align='center'}
